	    ...
	    return [
	      ...
	      },
	      {
	        ...
	        systemPrompt:
	          ...
	          'НЕТ: localStorage, sessionStorage, indexedDB, XMLHttpRequest, WebSocket, доступа к странице ' +
	          'и к данным агента. Нужна память между вызовами — это инструмент persistent_memory, а не хранилище.\n' +
